real partial_log_like(array[] int n_slice, int start, int end, vector alpha, vector ec, vector K, array[,] vector observed_counts, array[,] vector background_counts, array[,] vector background_errors, array[,,] int mask, array[,] int N_channels_used, array[,] real exposure, array[,] vector ebounds_lo, array[,] vector ebounds_hi, array[,] vector ebounds_add, array[,] vector ebounds_half, array[,] matrix response, array[,,] int idx_background_zero, array[,,] int idx_background_nonzero, array[,] int N_bkg_zero, array[,] int N_bkg_nonzero, array[] int N_dets, array[,] int N_chan, array[,] int N_echan, int max_n_chan, real emin, real emax ) {
